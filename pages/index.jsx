...
export default function Home() {
    ...
    return (
        <div>
            ...
            <div className="w-auto relative xs:w-full shadow-none md:w-[1000px] md:min-w-[1000px] min-h-[600px] h-[600px] bg-[#ecf0f3] sm:shadow-auth-form-shadow-1 rounded-[12px] overflow-hidden transform md:scale-95 xl:scale-105">
